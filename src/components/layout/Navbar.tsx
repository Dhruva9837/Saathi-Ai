            ...
            {authUser ? (
              <div className="relative">
                <button
                  ...
                  className="flex items-center gap-2 pl-2 border-l border-surfaceBorder hover:opacity-85 transition-opacity"
                >
                ...
                {isUserMenuOpen && (
                  <div className="absolute right-0 mt-2 w-56 rounded-xl glass-panel-glow border border-surfaceBorder p-1.5 shadow-2xl z-50">
                    <div className="px-3 py-2 text-xs text-slate-400 border-b border-surfaceBorder">
                      Signed in as
                    ...
                    <button
                      ...
                      className="w-full mt-1 flex items-center gap-2 px-3 py-2 rounded-lg text-xs text-rose-400 hover:bg-rose-500/10 transition-colors font-medium"
                    >
              ...
              <button
                ...
                className="flex items-center gap-1.5 px-3 py-1.5 rounded-lg bg-surface border border-surfaceBorder text-slate-200 text-xs font-medium hover:border-primary-500 hover:text-white transition-all shadow-sm"
              >
                <LogIn className="h-3.5 w-3.5 text-primary-400" />
                <span>Sign In</span>
              </button>
            )}
          </div>
